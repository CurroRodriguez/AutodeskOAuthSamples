...
public interface OAuthService
{
  ...
  /**
   * Refresh the access token with sessionHandle
   * 
   * @param expiredToken expired access token (obtained previously)
   * @param sessionHandle session handle(obtained previously)
